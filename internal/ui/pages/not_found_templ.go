...
func NotFoundComponent() templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		ctx = templ.ClearChildren(ctx)
		templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 2, "<div class=\"min-h-screen flex items-center justify-center bg-base-100\"><div class=\"max-w-md mx-auto text-center px-6\"><div class=\"mb-8\"><div class=\"text-[180px] leading-none font-black text-base-300 select-none\">404</div><div class=\"text-6xl -mt-8\">🤔</div></div><h1 class=\"text-5xl font-bold mb-4 text-base-content\">Ой! Задача потерялась</h1><p class=\"text-xl text-base-content/70 mb-10\">Мы не смогли найти задачи, которые вы ищете.</p></div></div>")
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		return nil
